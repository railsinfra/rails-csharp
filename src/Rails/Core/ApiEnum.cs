    ...
    where TEnum : struct, Enum
{
    ...
    public TRaw Raw()
    {
        try
        {
            return JsonSerializer.Deserialize<TRaw>(this.Json, ModelBase.SerializerOptions)
                ?? throw new RailsInvalidDataException($"{nameof(this.Json)} cannot be null");
        }
        catch (JsonException e)
        {
            throw new RailsInvalidDataException(
    ...
    public void Validate()
    {
        ...
        {
            throw new RailsInvalidDataException("Invalid enum value");
        }
    }
