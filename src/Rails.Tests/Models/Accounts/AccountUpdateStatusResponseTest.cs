...
public class AccountUpdateStatusResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new AccountUpdateStatusResponse
        {
            ID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            AccountNumber = "account_number",
            AccountType = AccountUpdateStatusResponseAccountType.Checking,
            Balance = "balance",
            Currency = "currency",
            Environment = "environment",
            Status = AccountUpdateStatusResponseStatus.Active,
        ...
        ApiEnum<string, AccountUpdateStatusResponseAccountType> expectedAccountType =
            AccountUpdateStatusResponseAccountType.Checking;
        string expectedBalance = "balance";
        string expectedCurrency = "currency";
        string expectedEnvironment = "environment";
        ApiEnum<string, AccountUpdateStatusResponseStatus> expectedStatus =
            AccountUpdateStatusResponseStatus.Active;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<AccountUpdateStatusResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        AccountUpdateStatusResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class AccountUpdateStatusResponseAccountTypeTest : TestBase
{
    [Theory]
    [InlineData(AccountUpdateStatusResponseAccountType.Checking)]
    [InlineData(AccountUpdateStatusResponseAccountType.Saving)]
    public void Validation_Works(AccountUpdateStatusResponseAccountType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, AccountUpdateStatusResponseAccountType> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(AccountUpdateStatusResponseAccountType.Checking)]
    [InlineData(AccountUpdateStatusResponseAccountType.Saving)]
    public void SerializationRoundtrip_Works(AccountUpdateStatusResponseAccountType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, AccountUpdateStatusResponseAccountType> value = rawValue;
...
public class AccountUpdateStatusResponseStatusTest : TestBase
{
    [Theory]
    [InlineData(AccountUpdateStatusResponseStatus.Active)]
    [InlineData(AccountUpdateStatusResponseStatus.Suspended)]
    [InlineData(AccountUpdateStatusResponseStatus.Closed)]
    public void Validation_Works(AccountUpdateStatusResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, AccountUpdateStatusResponseStatus> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, AccountUpdateStatusResponseStatus>>(
    ...
    [InlineData(AccountUpdateStatusResponseStatus.Suspended)]
    [InlineData(AccountUpdateStatusResponseStatus.Closed)]
    public void SerializationRoundtrip_Works(AccountUpdateStatusResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, AccountUpdateStatusResponseStatus> value = rawValue;
