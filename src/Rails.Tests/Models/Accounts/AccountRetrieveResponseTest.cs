...
public class AccountRetrieveResponseTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new AccountRetrieveResponse
        {
            ...
            AccountType = AccountRetrieveResponseAccountType.Checking,
            Balance = "balance",
            Currency = "currency",
            Environment = "environment",
            Status = AccountRetrieveResponseStatus.Active,
        ...
        ApiEnum<string, AccountRetrieveResponseAccountType> expectedAccountType =
            AccountRetrieveResponseAccountType.Checking;
        string expectedBalance = "balance";
        string expectedCurrency = "currency";
        string expectedEnvironment = "environment";
        ApiEnum<string, AccountRetrieveResponseStatus> expectedStatus =
            AccountRetrieveResponseStatus.Active;
...
public class AccountRetrieveResponseAccountTypeTest : TestBase
{
    [Theory]
    [InlineData(AccountRetrieveResponseAccountType.Checking)]
    [InlineData(AccountRetrieveResponseAccountType.Saving)]
    public void Validation_Works(AccountRetrieveResponseAccountType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, AccountRetrieveResponseAccountType> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, AccountRetrieveResponseAccountType>>(
    ...
    [InlineData(AccountRetrieveResponseAccountType.Checking)]
    [InlineData(AccountRetrieveResponseAccountType.Saving)]
    public void SerializationRoundtrip_Works(AccountRetrieveResponseAccountType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, AccountRetrieveResponseAccountType> value = rawValue;
...
public class AccountRetrieveResponseStatusTest : TestBase
{
    [Theory]
    [InlineData(AccountRetrieveResponseStatus.Active)]
    [InlineData(AccountRetrieveResponseStatus.Suspended)]
    [InlineData(AccountRetrieveResponseStatus.Closed)]
    public void Validation_Works(AccountRetrieveResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, AccountRetrieveResponseStatus> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, AccountRetrieveResponseStatus>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(AccountRetrieveResponseStatus.Suspended)]
    [InlineData(AccountRetrieveResponseStatus.Closed)]
    public void SerializationRoundtrip_Works(AccountRetrieveResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, AccountRetrieveResponseStatus> value = rawValue;
        ...
        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<
            ApiEnum<string, AccountRetrieveResponseStatus>
        >(json, ModelBase.SerializerOptions);
